...
#setting complex media constraints
...
model.reactions.EX_cl_e.lower_bound = -1000 #metal ions set as theoretical so not rate limiting
...
cobra.io.write_sbml_model(model,filename="C:/Work/ecoli_mod/eco_Lim_v2.xml")
...
flux.to_csv('C:/Work/ecoli_mod/flux_biomass.csv')
